...
\newcommand{\lastupdate}{June 2, 2026}
...
\newcommand{\cvheader}{%
  ...
  {\small
    ...
    \href{https://github.com/loggerJK}{\faGithub\ loggerJK}%
    % \cvgap\href{https://linkedin.com/in/TODO}{\faLinkedin\ LinkedIn}   % TODO: LinkedIn
  }\par
  \vspace{10pt}
}
...
\newcommand{\cventry}[4]{%
  \textbf{#1}\hfill{#2}\par
  \def\cv@second{#3}%
  \ifx\cv@second\@empty\else #3\hfill{#4}\par\fi
}
\makeatother
...
\begin{cvbullets}
  \item Double Major in Statistics \quad GPA: 4.24 / 4.5
...
\pubitem{[C2]}
  ...
  {} % TODO: add Paper / Project Page / Code links
