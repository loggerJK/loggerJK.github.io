...
\usepackage[letterpaper,left=0.75in,right=0.75in,top=0.6in,bottom=0.75in]{geometry}
...
\newcommand{\cvheader}{%
  ...
  % \vspace{6pt}
  {\small
    \href{https://loggerjk.github.io/}{\faHome\ Personal Website}\cvgap
...
\newcommand{\largesection}[1]{\vspace{1pt} \section{\LARGE#1} \vspace{1pt}}
...
Having started my research career in 3D vision, I expanded my focus during my Master's to Generative AI, including its practical applications, and Unified Multimodal Models (UMMs). Recently, I have become interested in the challenge of world modeling by combining 3D vision capabilities with generative knowledge, which can be extended to real-world robotics and immersive gaming environments.
Key research areas include:
\begin{cvbullets}
  \vspace{-5pt}
  \item Diffusion \& Generative AI (Image Generation, Guidance, Sampling, Facial Generation)
...
\begin{cvbullets}
  ...
  \item Leave of Absence for R.O.K. Military Service (Dec. 2020 -- Jun. 2022)
...
\cventry{Kakao}{Mar. 2026 -- May 2026}{Research Intern}{\textit{Seoul, Korea}}
\begin{cvbullets}
  \item Worked on Text-to-Speech research, repurposing Whisper as a continuous tokenizer for autoregressive diffusion-based TTS model \hyperref[Whisper]{[P2]}.
\end{cvbullets}

\largesection{Projects}
\cventry{SAMSUNG}{Aug. 2025 -- Oct. 2025}{Research Collaboration}{\textit{Seoul, Korea}}
\begin{cvbullets}
  \item Collaborated with Samsung Electronics on background face anonymization via generative face-swapping \hyperref[APPLE]{[C3]}.
\end{cvbullets}
%-------------------- PUBLICATIONS --------------------
...
\pubitem{[P2]}
  ...
  {Under Review.}
  {\item Inspired by the success of RAE in the vision domain, we explored whether ASR-supervised audio representations (Whisper) could be repurposed as generative representations on top of an autoregressive diffusion-based TTS model.}
...
\cventry{Military Service (KATUSA, Korean Augmentation to the U.S. Army)}{Dec. 2020 -- Jun. 2022}{}{}
\begin{cvbullets}
  \item MOS : 92Y (Unit Supply Specialist)
  \item 194th DSSB, 2nd Infantry Division, Eighth U.S. Army, Camp Humphreys
\end{cvbullets}

\cventry{AIKU (Artificial Intelligence Society of Korea University)}{Sep. 2022 -- Aug. 2023}
        {}{}
\begin{cvbullets}
  \item Co-founder \& Vice President of academic research society for undergraduate students
\end{cvbullets}
