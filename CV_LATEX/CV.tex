...
\newcommand{\largesection}[1]{\vspace{3pt} \section{\LARGE#1} \vspace{3pt}}
...
Starting my research career in 3D vision, I expanded my focus during my Master's to Generative AI, practical applications, and Unified Multimodal Models (UMMs). Recently, I am interested in the challenge of world modeling by combining 3D vision capabilities with generative knowledge, which can be extended to real world robotics and immersive gaming environments.
Key research areas include:
\begin{cvbullets}
  \vspace{-5pt}
  \item Diffusion \& Generative AI (Image Generation, Guidance, Sampling)
...
\cventry{SAMSUNG}{Aug. 2026 -- Oct. 2026}{Research Collaboration}{\textit{Seoul, Korea}}
\begin{cvbullets}
